...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOF, HEAD_LED_Pin|TEST_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : HEAD_LED_Pin */
  ...
  /*Configure GPIO pins : TEST_Pin MOTOR_SLEEP_Pin */
  GPIO_InitStruct.Pin = TEST_Pin|MOTOR_SLEEP_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  ...
  /*Configure GPIO pin : MOTOR_2_Pin */
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
  if (htim->Instance == TIM5)
  {
    // Toggle wheels
    if (wheels_running) {
      HAL_GPIO_WritePin(GPIOE, GPIO_PIN_11, GPIO_PIN_RESET); // Motors 2
      wheels_running = 0;
    } else {
      HAL_GPIO_WritePin(GPIOE, GPIO_PIN_11, GPIO_PIN_RESET); // Motors 2
      wheels_running = 1;
